...
% 
%  Step method syntax
% [Capture_Window,Trigger_Position,bo_bitstream,be_bitstream]=step(dco) connects to the FPGA, and read data from the FPGA.
% 
...
%
% Created: 20-Apr-2024 21:16:05
% Generated by MATLAB 9.14 and HDL Verifier 7.1
...
methods
    function obj = FPGADataCapture
        ...
        obj.setDataType('bo_bitstream',numerictype(1,16,15));
        obj.setDataType('be_bitstream',numerictype(1,16,15));
...
properties (Nontunable, Constant)
    ...
    SamplesPerFrame = 128
    BitWidth = [32   1  16  16]
    SignalNames = {'Capture_Window','Trigger_Position','bo_bitstream','be_bitstream'}
    ...
    Version = '1.2'
    % Timestamp
    TimeStamp = '20-Apr-2024 21:16:05'
end
