-- -------------------------------------------------------------
-- 
-- File Name: /home/matt/OPV_TX_abraxas3d/create-even-and-odd-HDL/hdlsrc/opv_pluto_transmitter_HDL_coder_input/opv_modul_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: opv_modul_ip_axi_lite
-- Source Path: opv_modul_ip/opv_modul_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY opv_modul_ip_axi_lite IS
...
END opv_modul_ip_axi_lite;


ARCHITECTURE rtl OF opv_modul_ip_axi_lite IS

  -- Component Declarations
  COMPONENT opv_modul_ip_addr_decoder
  ...
  COMPONENT opv_modul_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : opv_modul_ip_addr_decoder
    USE ENTITY work.opv_modul_ip_addr_decoder(rtl);

  FOR ALL : opv_modul_ip_axi_lite_module
    USE ENTITY work.opv_modul_ip_axi_lite_module(rtl);
...
BEGIN
  u_opv_modul_ip_addr_decoder_inst : opv_modul_ip_addr_decoder
  ...
  u_opv_modul_ip_axi_lite_module_inst : opv_modul_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
