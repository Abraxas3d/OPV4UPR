-- -------------------------------------------------------------
-- 
-- File Name: /home/matt/OPV_TX_abraxas3d/preamble-HDL/hdlsrc/opv_pluto_transmitter_HDL_coder_input/opv_modul_ip_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: opv_modul_ip_axi4
-- Source Path: opv_modul_ip/opv_modul_ip_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END opv_modul_ip_axi4;


ARCHITECTURE rtl OF opv_modul_ip_axi4 IS
  ...
  COMPONENT opv_modul_ip_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : opv_modul_ip_axi4_module
    USE ENTITY work.opv_modul_ip_axi4_module(rtl);
...
BEGIN
  u_opv_modul_ip_addr_decoder_inst : opv_modul_ip_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              read_Out1 => read_Out1,  -- ufix9
              data_read => top_data_read,  -- ufix32
              write_axi_enable => write_axi_enable,  -- ufix1
              strobe_cop_in_strobe => strobe_cop_in_strobe,  -- ufix1
              write_data => write_data  -- ufix1
              );

  u_opv_modul_ip_axi4_module_inst : opv_modul_ip_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
