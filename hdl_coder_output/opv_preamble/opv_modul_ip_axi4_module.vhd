-- -------------------------------------------------------------
-- 
-- File Name: /home/matt/OPV_TX_abraxas3d/preamble-HDL/hdlsrc/opv_pluto_transmitter_HDL_coder_input/opv_modul_ip_axi4_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: opv_modul_ip_axi4_module
-- Source Path: opv_modul_ip/opv_modul_ip_axi4/opv_modul_ip_axi4_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY opv_modul_ip_axi4_module IS
...
END opv_modul_ip_axi4_module;


ARCHITECTURE rtl OF opv_modul_ip_axi4_module IS

  -- Component Declarations
  COMPONENT opv_modul_ip_rdfifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT opv_modul_ip_rdfifo_rid
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT opv_modul_ip_rdfifo_last
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : opv_modul_ip_rdfifo_data
    USE ENTITY work.opv_modul_ip_rdfifo_data(rtl);

  FOR ALL : opv_modul_ip_rdfifo_rid
    USE ENTITY work.opv_modul_ip_rdfifo_rid(rtl);

  FOR ALL : opv_modul_ip_rdfifo_last
    USE ENTITY work.opv_modul_ip_rdfifo_last(rtl);
...
BEGIN
  u_opv_modul_ip_rdfifo_data_inst : opv_modul_ip_rdfifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_opv_modul_ip_rdfifo_rid_inst : opv_modul_ip_rdfifo_rid
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_opv_modul_ip_rdfifo_last_inst : opv_modul_ip_rdfifo_last
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
