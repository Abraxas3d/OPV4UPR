-- -------------------------------------------------------------
-- 
-- File Name: /home/matt/OPV_TX_abraxas3d/preamble-HDL/hdlsrc/opv_pluto_transmitter_HDL_coder_input/opv_modul_ip_rdfifo_last.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: opv_modul_ip_rdfifo_last
-- Source Path: opv_modul_ip/opv_modul_ip_axi4/opv_modul_ip_axi4_module/opv_modul_ip_rdfifo_last
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY opv_modul_ip_rdfifo_last IS
...
END opv_modul_ip_rdfifo_last;


ARCHITECTURE rtl OF opv_modul_ip_rdfifo_last IS

  -- Component Declarations
  COMPONENT opv_modul_ip_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : opv_modul_ip_SimpleDualPortRAM_singlebit
    USE ENTITY work.opv_modul_ip_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_opv_modul_ip_rdfifo_last_classic_ram_singlebit : opv_modul_ip_SimpleDualPortRAM_singlebit
