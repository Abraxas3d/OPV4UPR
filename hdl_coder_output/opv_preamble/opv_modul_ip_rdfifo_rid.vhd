-- -------------------------------------------------------------
-- 
-- File Name: /home/matt/OPV_TX_abraxas3d/preamble-HDL/hdlsrc/opv_pluto_transmitter_HDL_coder_input/opv_modul_ip_rdfifo_rid.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: opv_modul_ip_rdfifo_rid
-- Source Path: opv_modul_ip/opv_modul_ip_axi4/opv_modul_ip_axi4_module/opv_modul_ip_rdfifo_rid
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY opv_modul_ip_rdfifo_rid IS
...
END opv_modul_ip_rdfifo_rid;


ARCHITECTURE rtl OF opv_modul_ip_rdfifo_rid IS

  -- Component Declarations
  COMPONENT opv_modul_ip_SimpleDualPortRAM_generic
  ...
  FOR ALL : opv_modul_ip_SimpleDualPortRAM_generic
    USE ENTITY work.opv_modul_ip_SimpleDualPortRAM_generic(rtl);
  ...
  SIGNAL cache_data                       : unsigned(11 DOWNTO 0);  -- ufix12
  SIGNAL data_out_next                    : unsigned(11 DOWNTO 0);  -- ufix12
  SIGNAL Out_tmp                          : unsigned(11 DOWNTO 0);  -- ufix12

BEGIN
  -- us1: Upsample by 1, Sample offset 0 
  u_opv_modul_ip_rdfifo_rid_classic_ram : opv_modul_ip_SimpleDualPortRAM_generic
  ...
  BEGIN
    IF reset = '1' THEN
      cache_data <= to_unsigned(16#000#, 12);
    ELSIF clk'EVENT AND clk = '1' THEN
