-- -------------------------------------------------------------
-- 
-- File Name: /home/matt/OPV_TX_abraxas3d/preamble-HDL/hdlsrc/opv_pluto_transmitter_HDL_coder_input/preamble_sample_and_hold.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: preamble_sample_and_hold
...
ENTITY preamble_sample_and_hold IS
...
END preamble_sample_and_hold;


ARCHITECTURE rtl OF preamble_sample_and_hold IS
...
BEGIN
  preamble_sample_and_hold_1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      sample_held <= '0';
      output_held_value <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      ...
      END IF;
    END IF;
  END PROCESS preamble_sample_and_hold_1_process;

  preamble_sample_and_hold_1_output : PROCESS (input, output_held_value, reset_1, sample_held, trigger)
  ...
  BEGIN
    ...
    CASE index IS
      ...
      WHEN OTHERS => 
        output <= '0';
    END CASE;
  END PROCESS preamble_sample_and_hold_1_output;
