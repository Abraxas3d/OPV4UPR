-- -------------------------------------------------------------
-- 
-- File Name: /home/matt/OPV_TX_abraxas3d/preamble-HDL/hdlsrc/opv_pluto_transmitter_HDL_coder_input/opv_modul_ip.vhd
...
ARCHITECTURE rtl OF opv_modul_ip IS
  ...
  FOR ALL : opv_modul_ip_cop
    USE ENTITY work.opv_modul_ip_cop(rtl);

  FOR ALL : opv_modul_ip_axi4
    USE ENTITY work.opv_modul_ip_axi4(rtl);
  ...
  SIGNAL write_data                       : std_logic;  -- ufix1
...
BEGIN
  ...
  u_opv_modul_ip_cop_inst : opv_modul_ip_cop
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  u_opv_modul_ip_axi4_inst : opv_modul_ip_axi4
  ...
  ip_timestamp <= unsigned'(X"8F4D0831");
